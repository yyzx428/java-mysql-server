...
public class MySqlLexer extends Lexer {
	...
	public static final int
		...
		RESOURCE_GROUP_USER=733, ROLE_ADMIN=734, ROUTINE=735, S3=736, SERVICE_CONNECTION_ADMIN=737, 
		SESSION_VARIABLES_ADMIN=738, SET_USER_ID=739, SHOW_ROUTINE=740, SHUTDOWN=741, 
		SUPER=742, SYSTEM_VARIABLES_ADMIN=743, TABLES=744, TABLE_ENCRYPTION_ADMIN=745, 
		VERSION_TOKEN_ADMIN=746, XA_RECOVER_ADMIN=747, ARMSCII8=748, ASCII=749, 
		BIG5=750, CP1250=751, CP1251=752, CP1256=753, CP1257=754, CP850=755, CP852=756, 
		CP866=757, CP932=758, DEC8=759, EUCJPMS=760, EUCKR=761, GB18030=762, GB2312=763, 
		GBK=764, GEOSTD8=765, GREEK=766, HEBREW=767, HP8=768, KEYBCS2=769, KOI8R=770, 
		KOI8U=771, LATIN1=772, LATIN2=773, LATIN5=774, LATIN7=775, MACCE=776, 
		MACROMAN=777, SJIS=778, SWE7=779, TIS620=780, UCS2=781, UJIS=782, UTF16=783, 
		UTF16LE=784, UTF32=785, UTF8=786, UTF8MB3=787, UTF8MB4=788, ARCHIVE=789, 
		BLACKHOLE=790, CSV=791, FEDERATED=792, INNODB=793, MEMORY=794, MRG_MYISAM=795, 
		MYISAM=796, NDB=797, NDBCLUSTER=798, PERFORMANCE_SCHEMA=799, TOKUDB=800, 
		REPEATABLE=801, COMMITTED=802, UNCOMMITTED=803, SERIALIZABLE=804, GEOMETRYCOLLECTION=805, 
		GEOMCOLLECTION=806, GEOMETRY=807, LINESTRING=808, MULTILINESTRING=809, 
		MULTIPOINT=810, MULTIPOLYGON=811, POINT=812, POLYGON=813, ABS=814, ACOS=815, 
		ADDDATE=816, ADDTIME=817, AES_DECRYPT=818, AES_ENCRYPT=819, AREA=820, 
		ASBINARY=821, ASIN=822, ASTEXT=823, ASWKB=824, ASWKT=825, ASYMMETRIC_DECRYPT=826, 
		ASYMMETRIC_DERIVE=827, ASYMMETRIC_ENCRYPT=828, ASYMMETRIC_SIGN=829, ASYMMETRIC_VERIFY=830, 
		ATAN=831, ATAN2=832, BENCHMARK=833, BIN=834, BIT_COUNT=835, BIT_LENGTH=836, 
		BUFFER=837, CATALOG_NAME=838, CEIL=839, CEILING=840, CENTROID=841, CHARACTER_LENGTH=842, 
		CHARSET=843, CHAR_LENGTH=844, COERCIBILITY=845, COLLATION=846, COMPRESS=847, 
		CONCAT=848, CONCAT_WS=849, CONNECTION_ID=850, CONV=851, CONVERT_TZ=852, 
		COS=853, COT=854, CRC32=855, CREATE_ASYMMETRIC_PRIV_KEY=856, CREATE_ASYMMETRIC_PUB_KEY=857, 
		CREATE_DH_PARAMETERS=858, CREATE_DIGEST=859, CROSSES=860, DATEDIFF=861, 
		DATE_FORMAT=862, DAYNAME=863, DAYOFMONTH=864, DAYOFWEEK=865, DAYOFYEAR=866, 
		DECODE=867, DEGREES=868, DES_DECRYPT=869, DES_ENCRYPT=870, DIMENSION=871, 
		DISJOINT=872, DISTANCE=873, ELT=874, ENCODE=875, ENCRYPT=876, ENDPOINT=877, 
		ENGINE_ATTRIBUTE=878, ENVELOPE=879, EQUALS=880, EXP=881, EXPORT_SET=882, 
		EXTERIORRING=883, EXTRACTVALUE=884, FIELD=885, FIND_IN_SET=886, FLOOR=887, 
		FORMAT=888, FOUND_ROWS=889, FROM_BASE64=890, FROM_DAYS=891, FROM_UNIXTIME=892, 
		GEOMCOLLFROMTEXT=893, GEOMCOLLFROMWKB=894, GEOMETRYCOLLECTIONFROMTEXT=895, 
		GEOMETRYCOLLECTIONFROMWKB=896, GEOMETRYFROMTEXT=897, GEOMETRYFROMWKB=898, 
		GEOMETRYN=899, GEOMETRYTYPE=900, GEOMFROMTEXT=901, GEOMFROMWKB=902, GET_FORMAT=903, 
		GET_LOCK=904, GLENGTH=905, GREATEST=906, GTID_SUBSET=907, GTID_SUBTRACT=908, 
		HEX=909, IFNULL=910, INET6_ATON=911, INET6_NTOA=912, INET_ATON=913, INET_NTOA=914, 
		INSTR=915, INTERIORRINGN=916, INTERSECTS=917, ISCLOSED=918, ISEMPTY=919, 
		ISNULL=920, ISSIMPLE=921, IS_FREE_LOCK=922, IS_IPV4=923, IS_IPV4_COMPAT=924, 
		IS_IPV4_MAPPED=925, IS_IPV6=926, IS_USED_LOCK=927, LAST_INSERT_ID=928, 
		LCASE=929, LEAST=930, LENGTH=931, LINEFROMTEXT=932, LINEFROMWKB=933, LINESTRINGFROMTEXT=934, 
		LINESTRINGFROMWKB=935, LN=936, LOAD_FILE=937, LOCATE=938, LOG=939, LOG10=940, 
		LOG2=941, LOWER=942, LPAD=943, LTRIM=944, MAKEDATE=945, MAKETIME=946, 
		MAKE_SET=947, MASTER_POS_WAIT=948, MBRCONTAINS=949, MBRDISJOINT=950, MBREQUAL=951, 
		MBRINTERSECTS=952, MBROVERLAPS=953, MBRTOUCHES=954, MBRWITHIN=955, MD5=956, 
		MLINEFROMTEXT=957, MLINEFROMWKB=958, MONTHNAME=959, MPOINTFROMTEXT=960, 
		MPOINTFROMWKB=961, MPOLYFROMTEXT=962, MPOLYFROMWKB=963, MULTILINESTRINGFROMTEXT=964, 
		MULTILINESTRINGFROMWKB=965, MULTIPOINTFROMTEXT=966, MULTIPOINTFROMWKB=967, 
		MULTIPOLYGONFROMTEXT=968, MULTIPOLYGONFROMWKB=969, NAME_CONST=970, NULLIF=971, 
		NUMGEOMETRIES=972, NUMINTERIORRINGS=973, NUMPOINTS=974, OCT=975, OCTET_LENGTH=976, 
		ORD=977, OVERLAPS=978, PERCONA_SEQUENCE_TABLE=979, PERIOD_ADD=980, PERIOD_DIFF=981, 
		PI=982, POINTFROMTEXT=983, POINTFROMWKB=984, POINTN=985, POLYFROMTEXT=986, 
		POLYFROMWKB=987, POLYGONFROMTEXT=988, POLYGONFROMWKB=989, POW=990, POWER=991, 
		QUOTE=992, RADIANS=993, RAND=994, RANDOM=995, RANDOM_BYTES=996, RELEASE_LOCK=997, 
		REVERSE=998, ROUND=999, ROW_COUNT=1000, RPAD=1001, RTRIM=1002, SEC_TO_TIME=1003, 
		SECONDARY_ENGINE=1004, SECONDARY_ENGINE_ATTRIBUTE=1005, SEQUENCE_TABLE=1006, 
		...
		ST_UNION=1076, ST_WITHIN=1077, ST_X=1078, ST_Y=1079, STRING_TO_VECTOR=1080, 
		SUBDATE=1081, SUBSTRING_INDEX=1082, SUBTIME=1083, SYSTEM_USER=1084, TAN=1085, 
		TELEMETRY_LOG_ADMIN=1086, TIMEDIFF=1087, TIMESTAMPADD=1088, TIMESTAMPDIFF=1089, 
		TIME_FORMAT=1090, TIME_TO_SEC=1091, TOUCHES=1092, TO_BASE64=1093, TO_DAYS=1094, 
		TO_SECONDS=1095, TP_CONNECTION_ADMIN=1096, UCASE=1097, UNCOMPRESS=1098, 
		UNCOMPRESSED_LENGTH=1099, UNHEX=1100, UNIX_TIMESTAMP=1101, UPDATEXML=1102, 
		UPPER=1103, UUID=1104, UUID_SHORT=1105, VALIDATE_PASSWORD_STRENGTH=1106, 
		VECTOR_DIM=1107, VECTOR_TO_STRING=1108, VERSION=1109, WAIT_UNTIL_SQL_THREAD_AFTER_GTIDS=1110, 
		WEEKDAY=1111, WEEKOFYEAR=1112, WEIGHT_STRING=1113, WITHIN=1114, YEARWEEK=1115, 
		Y_FUNCTION=1116, X_FUNCTION=1117, VAR_ASSIGN=1118, PLUS_ASSIGN=1119, MINUS_ASSIGN=1120, 
		MULT_ASSIGN=1121, DIV_ASSIGN=1122, MOD_ASSIGN=1123, AND_ASSIGN=1124, XOR_ASSIGN=1125, 
		OR_ASSIGN=1126, STAR=1127, DIVIDE=1128, MODULE=1129, PLUS=1130, MINUS=1131, 
		DIV=1132, MOD=1133, EQUAL_SYMBOL=1134, GREATER_SYMBOL=1135, LESS_SYMBOL=1136, 
		EXCLAMATION_SYMBOL=1137, BIT_NOT_OP=1138, BIT_OR_OP=1139, BIT_AND_OP=1140, 
		BIT_XOR_OP=1141, DOT=1142, LR_BRACKET=1143, RR_BRACKET=1144, COMMA=1145, 
		SEMI=1146, AT_SIGN=1147, ZERO_DECIMAL=1148, ONE_DECIMAL=1149, TWO_DECIMAL=1150, 
		SINGLE_QUOTE_SYMB=1151, DOUBLE_QUOTE_SYMB=1152, REVERSE_QUOTE_SYMB=1153, 
		COLON_SYMB=1154, CHARSET_REVERSE_QOUTE_STRING=1155, FILESIZE_LITERAL=1156, 
		START_NATIONAL_STRING_LITERAL=1157, STRING_LITERAL=1158, DECIMAL_LITERAL=1159, 
		HEXADECIMAL_LITERAL=1160, REAL_LITERAL=1161, NULL_SPEC_LITERAL=1162, BIT_STRING=1163, 
		STRING_CHARSET_NAME=1164, DOT_ID=1165, ID=1166, REVERSE_QUOTE_ID=1167, 
		HOST_IP_ADDRESS=1168, LOCAL_ID=1169, GLOBAL_ID=1170, ERROR_RECONGNIGION=1171;
	public static final int
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"OCT", "OCTET_LENGTH", "ORD", "OVERLAPS", "PERCONA_SEQUENCE_TABLE", "PERIOD_ADD", 
			"PERIOD_DIFF", "PI", "POINTFROMTEXT", "POINTFROMWKB", "POINTN", "POLYFROMTEXT", 
			"POLYFROMWKB", "POLYGONFROMTEXT", "POLYGONFROMWKB", "POW", "POWER", "QUOTE", 
			"RADIANS", "RAND", "RANDOM", "RANDOM_BYTES", "RELEASE_LOCK", "REVERSE", 
			"ROUND", "ROW_COUNT", "RPAD", "RTRIM", "SEC_TO_TIME", "SECONDARY_ENGINE", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'MEDIUMTEXT'", "'LONGTEXT'", "'ENUM'", "'VARYING'", "'SERIAL'", "'VECTOR'", 
			...
			"'PERIOD_ADD'", "'PERIOD_DIFF'", "'PI'", "'POINTFROMTEXT'", "'POINTFROMWKB'", 
			"'POINTN'", "'POLYFROMTEXT'", "'POLYFROMWKB'", "'POLYGONFROMTEXT'", "'POLYGONFROMWKB'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"TEXT", "MEDIUMTEXT", "LONGTEXT", "ENUM", "VARYING", "SERIAL", "VECTOR", 
			"YEAR_MONTH", "DAY_HOUR", "DAY_MINUTE", "DAY_SECOND", "HOUR_MINUTE", 
			"HOUR_SECOND", "MINUTE_SECOND", "SECOND_MICROSECOND", "MINUTE_MICROSECOND", 
			"HOUR_MICROSECOND", "DAY_MICROSECOND", "JSON_ARRAY", "JSON_ARRAYAGG", 
			"JSON_ARRAY_APPEND", "JSON_ARRAY_INSERT", "JSON_CONTAINS", "JSON_CONTAINS_PATH", 
	...
	private static final String _serializedATNSegment1 =
		...
		"\u0931\u0000\u0933\u0000\u0935\u0000\u0937\u0000\u0939\u0000\u093b\u0493"+
		"\u0001\u0000*\u0003\u0000\t\n\r\r  \u0002\u0000\t\t  \u0002\u0000\n\n"+
		"\r\r\u0002\u0000AAaa\u0002\u0000DDdd\u0002\u0000LLll\u0002\u0000TTtt\u0002"+
		"\u0000EEee\u0002\u0000RRrr\u0002\u0000WWww\u0002\u0000YYyy\u0002\u0000"+
		"SSss\u0002\u0000NNnn\u0002\u0000ZZzz\u0002\u0000CCcc\u0002\u0000IIii\u0002"+
		"\u0000BBbb\u0002\u0000UUuu\u0002\u0000FFff\u0002\u0000OOoo\u0002\u0000"+
		"HHhh\u0002\u0000KKkk\u0002\u0000GGgg\u0002\u0000MMmm\u0002\u0000VVvv\u0002"+
		"\u0000PPpp\u0002\u0000XXxx\u0002\u0000JJjj\u0002\u0000QQqq\b\u0000GGK"+
		"KMMTTggkkmmtt\u0007\u0000$$..09AZ__az\u0080\u8000\uffff\u0002\u0000++"+
		"--\u0006\u0000$$09AZ__az\u0080\u8000\uffff\u0005\u0000$$AZ__az\u0080\u8000"+
		"\uffff\u0002\u0000\"\"\\\\\u0002\u0000\'\'\\\\\u0001\u0000``\u0003\u0000"+
		"09AFaf\u0001\u000009\u0001\u000001\u0002\u0000..09\u0003\u00000:AFaf\u36a0"+
		"\u0000\u0001\u0001\u0000\u0000\u0000\u0000\u0003\u0001\u0000\u0000\u0000"+
		"\u0000\u0005\u0001\u0000\u0000\u0000\u0000\u0007\u0001\u0000\u0000\u0000"+
		"\u0000\t\u0001\u0000\u0000\u0000\u0000\u000b\u0001\u0000\u0000\u0000\u0000"+
		"\r\u0001\u0000\u0000\u0000\u0000\u000f\u0001\u0000\u0000\u0000\u0000\u0011"+
